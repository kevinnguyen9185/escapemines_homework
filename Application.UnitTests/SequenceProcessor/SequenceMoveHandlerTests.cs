...
namespace Application.UnitTests.SequenceProcessor
{
    ...
    {
        [Theory]
        [InlineData(MoveBehaviorEnum.Move, DirectionEnum.North, 0, 1, DirectionEnum.North, 0, 1)]
        [InlineData(MoveBehaviorEnum.Move, DirectionEnum.North, 1, 0, DirectionEnum.North, 0, 0)]
        [InlineData(MoveBehaviorEnum.Move, DirectionEnum.South, 4, 2, DirectionEnum.South, 4, 2)]
        [InlineData(MoveBehaviorEnum.Move, DirectionEnum.South, 3, 2, DirectionEnum.South, 4, 2)]
        [InlineData(MoveBehaviorEnum.Move, DirectionEnum.East, 1, 4, DirectionEnum.East, 1, 4)]
        [InlineData(MoveBehaviorEnum.Move, DirectionEnum.East, 1, 3, DirectionEnum.East, 1, 4)]
        [InlineData(MoveBehaviorEnum.Move, DirectionEnum.West, 1, 0, DirectionEnum.West, 1, 0)]
        [InlineData(MoveBehaviorEnum.Move, DirectionEnum.West, 1, 1, DirectionEnum.West, 1, 0)]
